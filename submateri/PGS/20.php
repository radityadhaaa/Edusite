...
$listSubMateri = readSubMateriPGS20();
?>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1 text-center">
					<ul class="hero-area-tree">
						<li><a href="../../index.php">Home</a></li>
						<li><a href="../../pembelajaran.php">Pembelajaran</a></li>
						<li><a href="../../materi/PGS.php">Postgresql</a></li>
						<li>Instalasi dan Setup Software</li>
					</ul>
					<h1 class="white-text">Instalasi dan Setup Software</h1>
