	...
	<body>
		...
		<div id="blog" class="section">
			...
			<div class="container">
				...
				<!-- row -->
				<div class="row">
					<h4>Roadmap untuk menjadi Postgresql:</h4>
					<br>
					<form method="get" action="../doc/PGS.pdf">
						...
						<div class="row">
							...
							?>
								...
								<div class="single-blog">
									<div class="blog-img">
										<a href="../submateri/PGS/<?=$materi['id_materi']?>.php">
											<img src="../assets/img/materi/<?=$materi['foto_materi']?>" alt="">
										</a>
									</div>
									<h5><a href="../submateri/PGS/<?=$materi['id_materi']?>.php"><?=$materi['nama_materi']?></a></h5>
								</div>
							</div>
							<?php 
							}
