	...
	<body>
		...
		<div id="blog" class="section">
			...
			<div class="container">
				...
				<!-- row -->
				<div class="row">
					<h4>Roadmap untuk menjadi Back End:</h4>
					<br>
					<form method="get" action="../doc/BE.pdf">
						...
						<div class="row">
							...
							?>
								...
								<div class="single-blog">
									<div class="blog-img">
										<a href="../submateri/BE/<?=$materi['id_materi']?>.php">
											<img src="../assets/img/materi/<?=$materi['foto_materi']?>" alt="">
										</a>
									</div>
									<h4><a href="../submateri/BE/<?=$materi['id_materi']?>.php"><?=$materi['nama_materi']?></a></h4>
								</div>
							</div>
							<?php 
							}
